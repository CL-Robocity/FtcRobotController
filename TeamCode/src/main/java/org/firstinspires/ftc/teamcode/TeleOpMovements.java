...
@Disabled
@TeleOp (name = "prove di Zeno - FGC",group = "TeleOp Competition")
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (opModeIsActive()){
            ...
            if (gamepad1.right_bumper){
                ...
                upIntakeSlowMotor.setPower(1); //prova per far salire le palline
...
import com.qualcomm.robotcore.util.ElapsedTime;
            ...
            public class TeleOpMovements extends LinearOpMode {
                ...
                boolean bStateBefore = false;    // stato precedente del tasto cerchio (gamepad2.b) per rilevare il click
                boolean servoIsMoving = false;
                boolean barsOut = false;
                boolean barsInside = true;
                double crservoPower = 1.0;
                ...
                public void runOpMode() throws InterruptedException{
                    ...
                    while (opModeIsActive()){
                        ...
                        // SERVO TOGGLE WITH CERCHIO (gamepad2.b) - APERTO/CHIUSO

                        boolean bStateActual = gamepad2.b;
                        ...
                        // OPEN THE SERVOS AND MAKING THE INTAKE GO (croce gamepad1.a, tenuto premuto - ha priorità sul toggle)
...
*/
                        ...
                        telemetry.addData("Servo's state (toggle)", (servoToggleOpen) ? "OPEN" : "CLOSE");
                        telemetry.update();
                    }
                }
